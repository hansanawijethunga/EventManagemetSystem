...
import { FiEdit2, FiTrash2, FiPlus, FiDollarSign, FiMapPin, FiLoader } from 'react-icons/fi';
...
const EventPackages = () => {
  ...
  useEffect(() => {
    if (currentUser && Array.isArray(eventTypes) && Array.isArray(eventPackages)) {
  ...
  }, [currentUser, eventTypes, eventPackages, getEventTypesByOrganizer, getEventPackagesByOrganizer, loading]);
  ...
  const getEventTypeName = (eventTypeId) => {
    const eventType = organizerEventTypes.find(type => type.id === eventTypeId);
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          disabled={!Array.isArray(organizerEventTypes) || organizerEventTypes.length === 0}
        >
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                You need to create at least one event type before you can add packages.
                <a href="/organizer/event-types" className="font-medium underline text-yellow-700 hover:text-yellow-600 ml-1">
                  Create Event Type
                </a>
              </p>
            </div>
      ...
      {!Array.isArray(organizerPackages) || organizerPackages.length === 0 ? (
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          <p className="text-gray-600 mb-4">You haven't created any event packages yet.</p>
          {Array.isArray(organizerEventTypes) && organizerEventTypes.length > 0 && (
            <button
              onClick={openAddModal}
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {organizerPackages.map((eventPackage) => (
            <div key={eventPackage.id} className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">{eventPackage.title || 'Unnamed Package'}</h3>
                  <span className={`text-xs px-2 py-1 rounded-full ${
                    eventPackage.status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                  }`}>
                ...
                <p className="text-gray-600 mb-6 line-clamp-3">{eventPackage.description || 'No description available'}</p>
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <Formik
              initialValues={{
                ...
                eventTypeId: currentPackage?.eventTypeId || (organizerEventTypes.length > 0 ? organizerEventTypes[0].id : ''),
              ...
              {({ isSubmitting }) => (
                <Form className="space-y-4">
                  ...
                  <div>
                    ...
                    <ErrorMessage name="eventTypeId" component="p" className="error-message" />
                  </div>
                  ...
                  <div>
                    ...
                    <Field
                      ...
                      className="input-field"
                    />
                    <ErrorMessage name="location" component="p" className="error-message" />
                  </div>
                  ...
                  <div>
                    ...
                    <Field
                      ...
                      className="input-field"
                    />
                    <ErrorMessage name="imageUrl" component="p" className="error-message" />
