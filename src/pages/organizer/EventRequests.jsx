                  ...
                  return (
                    <tr key={request.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{packageDetails.title}</div>
                        <div className="text-sm text-gray-500">${packageDetails.price}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{formatDate(request.eventDate)}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{request.attendees}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <p className="text-base font-medium text-gray-900">
                  ${getPackageDetails(selectedRequest.packageId).price}
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-base text-gray-900">{formatDate(selectedRequest.eventDate)}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-base text-gray-900">{formatDate(selectedRequest.requestDate)}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-base text-gray-900">{selectedRequest.attendees} people</p>
                </div>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="bg-gray-50 p-3 rounded-md">
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-900">{selectedRequest.comments || 'No comments provided.'}</p>
                </div>
              </div>
            </div>
