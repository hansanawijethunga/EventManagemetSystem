                ...
                <div key={request.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="p-6">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                      <div>
                        <h2 className="text-xl font-semibold text-gray-900 mb-1">{packageDetails.title}</h2>
                        <p className="text-sm text-gray-600">Request ID: {request.id}</p>
                      </div>
                      <span className={`mt-2 md:mt-0 px-3 py-1 text-xs rounded-full inline-flex items-center ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      <div>
                        <h3 className="text-xs font-medium text-gray-500 uppercase">Event Date</h3>
                      ...
                      <div>
                        <h3 className="text-xs font-medium text-gray-500 uppercase">Attendees</h3>
                        <p className="mt-1 flex items-center">
                      ...
                      <div>
                        <h3 className="text-xs font-medium text-gray-500 uppercase">Price</h3>
                        <p className="mt-1 flex items-center">
